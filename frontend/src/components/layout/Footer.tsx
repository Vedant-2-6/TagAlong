          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center">
                ...
                <a href="tel:+919016030308" className="text-gray-400 hover:text-teal-400 transition-colors">+91 9016030308</a>
              </li>
              <li className="flex items-center">
                <Mail size={18} className="text-teal-400 mr-2 flex-shrink-0" />
                <a href="mailto:vedantpatelvp04@gmail.com" className="text-gray-400 hover:text-teal-400 transition-colors">vedantpatelvp04@gmail.com</a>
              </li>
            </ul>
          </div>
        </div>
