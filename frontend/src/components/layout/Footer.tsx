        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              <img src={logo} alt="TagAlong Logo" className="h-8 w-8 object-contain" />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/trust-safety" className="text-gray-400 hover:text-teal-400 transition-colors">Trust & Safety</Link>
              </li>
              <li>
