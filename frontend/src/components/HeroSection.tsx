...
const HeroSection: React.FC = () => {
  ...
  return (
    <div 
      ref={heroRef}
      className="relative min-h-screen pt-36 flex items-center justify-center bg-gradient-to-br from-teal-50 via-white to-blue-50"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-24 relative z-8">
